...
namespace PopForums.Services
{
	public interface IForumService
	{
		...
		Topic PostNewTopic(Forum forum, User user, ForumPermissionContext permissionContext, NewPost newPost, string ip, string userUrl, Func<Topic, string> topicLinkGenerator,DateTime timeStamp);
	    ...
	    int GetAggregatePostCountByStudent();
