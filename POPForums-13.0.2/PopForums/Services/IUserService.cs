...
namespace PopForums.Services
{
	public interface IUserService
	{
        ...
        User UpdateUser(int UserId, string name, string password, bool isApproved, int userType, int departmentId);
		...
		User CreateUser(string name, string email, string password, bool isApproved, string ip, int UserType,int departmnetId);
