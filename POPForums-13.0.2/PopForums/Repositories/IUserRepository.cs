...
namespace PopForums.Repositories
{
	public interface IUserRepository
	{
        ...
        User UpdateUser(int UserId, string name, DateTime creationDate, bool isApproved, string hashedPassword, Guid authorizationKey, Guid salt, int userType, int departmentId);
        /// <summary>
        ...
        User CreateUser(string name, string email, DateTime creationDate, bool isApproved, string hashedPassword, Guid authorizationKey, Guid salt, int userType,int departmentId);
        ...
        List<User> GetUserListByType(string type);
